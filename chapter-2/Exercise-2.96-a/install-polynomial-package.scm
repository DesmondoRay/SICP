    ...
    (let ((f1 (first-term l1))
      ...
      (let ((k (expt (coeff f2)
        ...
        (cadr (div-terms (times-term-list l1 k)
                         l2)))))
  ;; 测试pseudoremainder-terms
  ;(define termlist-1 '((4 11) (3 -22) (2 18) (1 -14) (0 7)))
  ;(define termlist-2 '((3 13) (2 -21) (1 3) (0 5)))
  ;(display (pseudoremainder-terms termlist-1 termlist-2))
  
  ;; exercise 2-96: gcd-terms
  (define (gcd-terms a b)
    (if (empty-termlist? b)
        a
        (gcd-terms b (pseudoremainder-terms a b))))
  ;; 测试gcd-terms
  ;(define t1 '((4 1) (3 -1) (2 -2) (1 2)))
  ;(define t2 '((3 1) (1 -1)))
  ;(display (gcd-terms t1 t2))
